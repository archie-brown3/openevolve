...
from examples.shipped.mlx_metal_kernel_opt.qwen3_benchmark_suite import Qwen3BenchmarkSuite, BenchmarkResult
from examples.shipped.mlx_metal_kernel_opt.quick_benchmark_test import run_quick_test
